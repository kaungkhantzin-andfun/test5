<div x-data="{ showSearch: false }">
    <div class="relative">
        ...
        <livewire:search-form
            main-class="container absolute inset-0 z-10 items-center justify-end hidden mx-auto lg:flex"
            searchWrapperClass="backdrop-blur max-w-md bg-opacity-30 bg-white mx-2 px-4 py-6 rounded-2xl shadow-2xl"
            inputClass="bg-gray-100 border border-gray-300 text-gray-800 shadow-none focus:border-0 focus:ring-0"
            class="space-y-4" class2="mt-4 space-y-6" :regions="$regions" :is-home="'true'" />

    </div>

    {{-- search black bg --}}
    <div x-show="showSearch" x-cloak x-transition
        class="fixed inset-0 z-30 flex items-end justify-center bg-black/60 lg:hidden">
    ...
    <div x-cloak @click.away="showSearch = false" @mouseover="showSearch = true"
        @keyup.escape.window="showSearch = false"
        :style="showSearch ? 'transform: translateX(0) translateY(-50%)' :
        ...
        <div
            class="max-w-[320px] xs:max-w-xs max-h-screen overflow-y-scroll sm:max-w-sm p-4 bg-white border border-gray-200 rounded shadow-raised">

            <livewire:search-form main-class="mt-2" searchWrapperClass="flex flex-col gap-2" class="flex flex-col gap-2"
                class2="flex flex-col gap-2" :regions="$regions" :is-drawer="'true'" />
    ...
    @if (!empty($types))
        <section wire:ignore class="relative h-[500px]">
            ...
            <img class="object-cover w-full h-full absolute top-0 left-0 z-0" src="{{ asset('assets/images/ny.jpg') }}"
                    ...
                    <div class="bg-yellow-400 bg-opacity-90 p-6 md:p-8 rounded shadow-md flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-black">
                                10 new offers every day. 350 offers on site, trusted by a community of thousands of
                                users.
                            </p>
                        </div>
                    </div>
    ...
    <section>
        ...
        <h2 class="text-3xl font-bold text-center text-black mb-10">Blog Posts</h2>
    ...
    <section class="bg-gray-700 py-20">
        <div class="container mx-auto px-20 ">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 place-items-center">
                <!-- Feature 1 -->
                <div style="border-top: 4px solid yellow"
                    class=" border-yellow-300 p-8 gap-4 flex text-white transform hover:-translate-y-2 transition-transform duration-300">
                    <div class="mb-4">
                        <svg class="w-16 h-16 mx-auto text-white" fill="none" stroke="currentColor"
                    ...
                    <div class="ms-5">
                        ...
                        <p class="text-gray-200">We have a proven track record of success, with thousands of satisfied
                            clients who have found their dream homes with us.</p>
                    </div>
                </div>
                <!-- Feature 1 -->
                <div style="border-top: 4px solid yellow"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="flex gap-10 p-4">
                    ...
                    <div class="text-start ms-6s">
                        ...
                        <p class="text-black text-sm">A revitalizing and fascinating occasion can be had while dating.
                            Additionally, it may drain your strength. For some, dating is a means of finding a lifelong
                            partner for a marria...</p>
                    </div>
                </div><!-- News Item 1 -->
                <div class="flex gap-10 p-4">
                    <div class="flex flex-col justify-start mb-6 me-6 px-6">
        ...
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="flex justify-center items-center gap-8 flex-wrap">
                ...
                <div class="text-center">
                    <div class="w-32 h-16 bg-gray-200 flex items-center justify-center text-gray-800 font-semibold">
                        High-Rise Real Estate Company</div>
                </div>
                <!-- Partner 2 -->
                <div class="text-center">
                    <div class="w-32 h-16 bg-gray-200 flex items-center justify-center text-gray-800 font-semibold">
                        Mark & Co. Buildings</div>
                </div>
                <!-- Partner 3 -->
                <div class="text-center">
                    <div class="w-32 h-16 bg-gray-200 flex items-center justify-center text-gray-800 font-semibold">
                        Real Estate Experts</div>
                </div>
                <!-- Partner 4 -->
                <div class="text-center">
                    <div class="w-32 h-16 bg-gray-200 flex items-center justify-center text-gray-800 font-semibold">
