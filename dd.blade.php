        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="card-overlay bg-white overflow-hidden transform transition duration-300">
                    <img src="http://127.0.0.1:8000/storage/card_22182601-0825553001750953303_6863625579565.webp"
                        alt="Apartment in NE 7th Victory Palace">
                    <div class="overlay-content">

                        <div>
                            <span class="inline-block px-2 py-1 text-lg  text-white ">Welcome to BR104 – Your Relaxing
                ...
                <div class="card-overlay bg-white overflow-hidden transform transition duration-300">
                    <img src="http://127.0.0.1:8000/storage/card_22182601-0825553001750953303_6863625579565.webp"
                        alt="Modern apartment on the Bay">
                    <div class="overlay-content">
                        <div>
                            <span class="inline-block px-2 py-1 text-lg   text-white ">Welcome to BR104 – Your Relaxing
                                Holiday Hideaway in Bali Residence!</span>
